...
public class FATags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> ARCANE_GOLD_INGOTS = commonTag("ingots/arcane_gold");
        public static final TagKey<Item> ARCANE_GOLD_NUGGETS = commonTag("nuggets/arcane_gold");

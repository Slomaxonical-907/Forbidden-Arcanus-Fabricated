...
import com.slomaxonical.forbidden_arcanus.common.block.misc.extended.*;
...
public class BlockRegistry implements BlockRegistryContainer {
    ...
    public static final Block DARKSTONE_STAIRS =  new ForbiddenStairsBlock(DARKSTONE.getDefaultState(), FabricBlockSettings.copy(Blocks.STONE).strength(4.5F, 8.0F));
    ...
    public static final Block POLISHED_DARKSTONE_STAIRS =  new ForbiddenStairsBlock(POLISHED_DARKSTONE.getDefaultState(), FabricBlockSettings.copy(Blocks.STONE_STAIRS).strength(4.5F, 8.0F));
    public static final Block POLISHED_DARKSTONE_WALL =  new WallBlock(FabricBlockSettings.copy(Blocks.STONE).strength(4.5F, 8.0F));
    public static final Block POLISHED_DARKSTONE_PRESSURE_PLATE =  new ForbiddenPressurePlateBlock(PressurePlateBlock.ActivationRule.MOBS, FabricBlockSettings.copy(Blocks.STONE_PRESSURE_PLATE).strength(0.5F));
    public static final Block POLISHED_DARKSTONE_BUTTON =  new ForbiddenStoneButtonBlock(FabricBlockSettings.copy(Blocks.STONE_BUTTON).strength(0.5F));
    ...
    public static final Block POLISHED_DARKSTONE_BRICK_STAIRS =  new ForbiddenStairsBlock(POLISHED_DARKSTONE_BRICKS.getDefaultState(), FabricBlockSettings.copy(Blocks.STONE_STAIRS).strength(4.5F, 8.0F));
    ...
    public static final Block ARCANE_POLISHED_DARKSTONE_STAIRS =  new ForbiddenStairsBlock(ARCANE_POLISHED_DARKSTONE.getDefaultState(), FabricBlockSettings.copy(Blocks.STONE_STAIRS).strength(4.5F, 8.0F));
    ...
    public static final Block ARCANE_GOLDEN_GLASS_PANE = new ForbiddenPaneBlock(FabricBlockSettings.copy(Blocks.GLASS_PANE));

    public static final Block RUNIC_GLASS_PANE =  new ForbiddenPaneBlock(FabricBlockSettings.copy(Blocks.GLASS_PANE));
    public static final Block DARK_RUNIC_GLASS_PANE =  new ForbiddenPaneBlock(FabricBlockSettings.copy(Blocks.GLASS_PANE));
    ...
    public static final Block SOULLESS_SANDSTONE_STAIRS =  new ForbiddenStairsBlock(SOULLESS_SANDSTONE.getDefaultState(), FabricBlockSettings.copy(Blocks.SANDSTONE_STAIRS));
    public static final Block POLISHED_SOULLESS_SANDSTONE_STAIRS =  new ForbiddenStairsBlock(POLISHED_SOULLESS_SANDSTONE.getDefaultState(), FabricBlockSettings.copy(Blocks.SANDSTONE_STAIRS));
    ...
    public static final Block FUNGYSS_STEM =  new RotatedPillarBlock(FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(2.0F).sounds(BlockSoundGroup.STEM));
    public static final Block CHERRYWOOD_LOG =  new RotatedPillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG));
    ...
    public static final Block EDELWOOD_LOG =  new EdelwoodLogBlock(FabricBlockSettings.copy(Blocks.OAK_LOG).color(MapColor.BROWN).ticksRandomly());
    public static final Block CARVED_EDELWOOD_LOG =  new CarvedEdelwoodLogBlock(FabricBlockSettings.copy(Blocks.OAK_LOG).color(MapColor.BROWN).ticksRandomly());
    public static final Block EDELWOOD_BRANCH =  new EdelwoodBranchBlock(FabricBlockSettings.copy(Blocks.OAK_LOG).color(MapColor.BROWN));
    public static final Block STRIPPED_CHERRYWOOD_LOG =  new RotatedPillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG));
    public static final Block STRIPPED_MYSTERYWOOD_LOG =  new MysterywoodLogBlock(FabricBlockSettings.copy(Blocks.OAK_LOG));
    public static final Block FUNGYSS_HYPHAE =  new RotatedPillarBlock(FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(2.0F).sounds(BlockSoundGroup.STEM));
    public static final Block CHERRYWOOD =  new RotatedPillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG));
    public static final Block MYSTERYWOOD =  new MysterywoodLogBlock(FabricBlockSettings.copy(Blocks.OAK_LOG));
    public static final Block STRIPPED_CHERRYWOOD =  new RotatedPillarBlock(FabricBlockSettings.copy(Blocks.OAK_LOG));
    ...
    public static final Block FUNGYSS_STAIRS =  new ForbiddenStairsBlock(FUNGYSS_PLANKS.getDefaultState(), FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD));
    public static final Block CHERRYWOOD_STAIRS =  new ForbiddenStairsBlock(CHERRYWOOD_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.OAK_STAIRS));
    public static final Block MYSTERYWOOD_STAIRS =  new ForbiddenStairsBlock(MYSTERYWOOD_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.OAK_STAIRS));
    public static final Block EDELWOOD_STAIRS =  new ForbiddenStairsBlock(EDELWOOD_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.OAK_STAIRS));

    public static final Block ARCANE_GOLD_DOOR =  new ForbiddenDoorBlock(FabricBlockSettings.of(Material.METAL, MapColor.GOLD).requiresTool().strength(3.0F).sounds(BlockSoundGroup.METAL).nonOpaque());
    public static final Block FUNGYSS_DOOR =  new ForbiddenDoorBlock(FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque());
    public static final Block CHERRYWOOD_DOOR =  new ForbiddenDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque());
    public static final Block MYSTERYWOOD_DOOR =  new ForbiddenDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque());
    public static final Block EDELWOOD_DOOR =  new ForbiddenDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque());
    public static final Block ARCANE_GOLD_TRAPDOOR =  new ForbiddenTrapDoorBlock(FabricBlockSettings.of(Material.METAL, MapColor.GOLD).requiresTool().strength(3.0F).sounds(BlockSoundGroup.METAL).nonOpaque().isValidSpawn(ModBlocks::never));
    public static final Block FUNGYSS_TRAPDOOR =  new ForbiddenTrapDoorBlock(FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque().isValidSpawn(ModBlocks::never));
    public static final Block CHERRYWOOD_TRAPDOOR =  new ForbiddenTrapDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque().isValidSpawn(ModBlocks::never));
    public static final Block MYSTERYWOOD_TRAPDOOR =  new ForbiddenTrapDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque().isValidSpawn(ModBlocks::never));
    public static final Block EDELWOOD_TRAPDOOR =  new ForbiddenTrapDoorBlock(FabricBlockSettings.of(Material.WOOD).strength(3.0F).sounds(BlockSoundGroup.WOOD).nonOpaque().isValidSpawn(ModBlocks::never));
    ...
    public static final Block EDELWOOD_LADDER =  new ForbiddenLadderBlock(FabricBlockSettings.copy(Blocks.LADDER));
    public static final Block FUNGYSS_BUTTON =  new ForbiddenWoodenButtonBlock(FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD));
    public static final Block CHERRYWOOD_BUTTON =  new ForbiddenWoodenButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON));
    public static final Block MYSTERYWOOD_BUTTON =  new ForbiddenWoodenButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON));
    public static final Block EDELWOOD_BUTTON =  new ForbiddenWoodenButtonBlock(FabricBlockSettings.copy(Blocks.OAK_BUTTON));
    public static final Block ARCANE_GOLD_PRESSURE_PLATE =  new ForbiddenPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.LIGHT_WEIGHTED_PRESSURE_PLATE));
    public static final Block FUNGYSS_PRESSURE_PLATE =  new ForbiddenPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.of(Material.WOOD, MapColor.WHITE_GRAY).strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD));
    public static final Block CHERRYWOOD_PRESSURE_PLATE =  new ForbiddenPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE));
    public static final Block MYSTERYWOOD_PRESSURE_PLATE =  new ForbiddenPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE));
    public static final Block EDELWOOD_PRESSURE_PLATE =  new ForbiddenPressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings.copy(Blocks.OAK_PRESSURE_PLATE));

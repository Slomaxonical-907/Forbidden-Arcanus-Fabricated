...
//
//                        ParticleS2CPacket packet = new ParticleS2CPacket(ParticleTypes.ANGRY_VILLAGER, false, posX, posY, posZ, 0.0F, ySpeed, 0.0F, 1.0F, 0);
//                        ((SendToPlayerIfNearbyInvoker)serverWorld).sendToPlayerIfNearbyInvoker(player, false, posX, posY, posZ, packet);
//                    });
//
